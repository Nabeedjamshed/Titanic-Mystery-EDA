...
elif analysis == "Gender Distribution":
...
elif analysis == "Passenger Class Analysis":
...
elif analysis == "Age Distribution":
...
elif analysis == "Family Size and Survival":
...
elif analysis == "Survival by Gender and Class":
...
elif analysis == "Interactive Fare Analysis (Plotly)":
